...
contract JointSavings {
  ...
  function withdraw(uint amount) public {
    ...
    // impose a withdraw threshold. 
    if(amount > address(this).balance / 3) {        // amount greater than 1/3 balance of contract 
                                                    // address(this) take the current contract address and calculate the balance in Ethereum and divide by 3. 

...
contract MartianMarket is ERC721Full, Ownable {                                                       
    ...
    // ERC721 mint with name and symbol 
    ...
    address payable foundation_address = msg.sender;                                  // after auction concluders land is transferred
    ...
    function createAuction(uint token_id) public onlyOwner {
        ...
        auction[token_id] = new MartianAuction(foundation_address);
    ...
    // WHY DO WE HAVE 2 FUNCTIONS FOR ENDING THE AUCTION????
